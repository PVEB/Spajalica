/**
 * Created by djnenadovic on 16.3.2017..
 */

angular.module("SpajalicaFrontEnd").directive('load-check', function($window) {
    return {
        link: function(scope, element, attrs) {

            console.log("Direktiva ucitana");
            ...
            jQuery(function($) {
                ...
                $(window).load(function() { // makes sure the whole site is loaded
                    ...
                    $('#main-wrapper').delay(1500).css({'overflow':'visible'});
                });
